...
<div class="container">
    ...
    <form>
        <div class="row">
            ...
            <div class="mt-3 mt-lg-0 col-lg-2 col-md-3 col-sm-3 d-none d-sm-block">
                <label for="pro_cat" class="float-md-right"><span class="d-sm-none d-md-inline"> Product </span> Category:</label>
            </div>
            <div class=" mt-3 mt-lg-0 col-lg-4 col-md-9 col-sm-8">
                <div class="input-group">
                    <div class="input-group-prepend">
        ...
        <div class="row my-3">
            <div class="col-lg-2 col-md-3 col-sm-3 d-none d-sm-block"></div>
            <div class="col-lg-4 col-md-9 col-sm-8">
